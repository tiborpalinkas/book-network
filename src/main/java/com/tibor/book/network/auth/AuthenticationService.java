package com.tibor.book.network.auth;

import com.tibor.book.network.email.EmailService;
import com.tibor.book.network.user.TokenRepository;
import com.tibor.book.network.auth.model.AuthenticationRequestDTO;
import com.tibor.book.network.auth.model.AuthenticationResponseDTO;
import com.tibor.book.network.email.EmailTemplateName;
import com.tibor.book.network.role.Role;
import com.tibor.book.network.role.RoleRepository;
import com.tibor.book.network.security.JwtService;
import com.tibor.book.network.user.Token;
import com.tibor.book.network.user.User;
import com.tibor.book.network.user.UserRepository;
